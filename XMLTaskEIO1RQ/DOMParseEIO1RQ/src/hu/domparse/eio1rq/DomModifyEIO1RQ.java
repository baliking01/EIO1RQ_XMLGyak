...
public class DomModifyEIO1RQ {
	...
	public static void modify(Document doc) {
		...
		// 2. Megrendelő emai címének módosítása
		NodeList clients = doc.getElementsByTagName("megrendelő");
		Element client = (Element) clients.item(1);
		client.getElementsByTagName("elérhetőség").item(0).setTextContent("rothmayerbt@gmail.comm");
		...
		// 1. Részleg vezetőjének és a kinevezés dátumának módosítása
